...
/* BEGIN OSV_FREE */
IPC_MESSAGE_ROUTED0(FrameMsg_ReceiveMessageFromMainFrame)
/* END OSV_FREE */
...
/* BEGIN OSV_FREE */
IPC_MESSAGE_ROUTED3(FrameHostMsg_MessageFromMainFrameReceived, base::string16, base::string16, bool)
/* END OSV_FREE */
