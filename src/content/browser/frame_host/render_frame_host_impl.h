...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  /* BEGIN OSV_FREE */
  using ReceiveMessageFromMainFrameCallback = base::Callback<void(
      const base::string16& frameOrigin, const base::string16& scriptOrigin, const base::string16& data, const bool isOnmessageInvolved)>;
  /* END OSV_FREE */
  ...
  /* BEGIN OSV_FREE */
  void ReceiveMessageFromMainFrame(ReceiveMessageFromMainFrameCallback callback);
  /* END OSV_FREE */
 ...
 private:
  ...
  /* BEGIN OSV_FREE */
  void OnMessageFromMainFrameReceived(base::string16 scriptUrl, base::string16 data, bool b);
  /* END OSV_FREE */
  ...
  /* BEGIN OSV_FREE */
  ReceiveMessageFromMainFrameCallback ReceiveMessageFromMainFrameCallback_;
  /* END OSV_FREE */
