...
import org.chromium.content_public.browser.ReceiveMessageFromMainFrameCallback;
/* END OSV_FREE */
...
/* package */ class WebContentsImpl implements WebContents, RenderFrameHostDelegate {
    ...
    private static void onSmartClipDataExtracted(
        ...
        /* BEGIN OSV_FREE */
        class ReceiveMessageFromMainFrameCallbackImpl implements ReceiveMessageFromMainFrameCallback {
                private Object mycallback;
                public ReceiveMessageFromMainFrameCallbackImpl(Object callback) {
                        mycallback = callback;
                }
                ...
                public void onMessageFromMainFrameReceived(String frameOrigin, String scriptOrigin, String data, boolean isProxyInvolved) throws Exception {
                        Method m = mycallback.getClass().getMethod("onMessageFromMainFrameReceived", new Class[]{String.class, String.class, String.class, boolean.class});
                        m.invoke(mycallback, new Object[]{frameOrigin, scriptOrigin, data, isProxyInvolved});
                        return;
                }
        }
        private ReceiveMessageFromMainFrameCallbackImpl mReceiveMessageFromMainFrameCallback;

        @Override
        public void receiveMessageFromMainFrame(final Object callback) throws Exception {

                System.out.println("WebContentsImpl@receiveMessageFromMainFrame@1");
                if (null == callback)
                        throw new IllegalStateException("callback is null");

                System.out.println("WebContentsImpl@receiveMessageFromMainFrame@2");
                mReceiveMessageFromMainFrameCallback = new ReceiveMessageFromMainFrameCallbackImpl(callback);
                nativeReceiveMessageFromMainFrame(mNativeWebContentsAndroid, mReceiveMessageFromMainFrameCallback);
        }

        @CalledByNative
        private static void onMessageFromMainFrameReceived(
            String frameOrigin, String scriptOrigin, String data, boolean isProxyInvolved,
            ReceiveMessageFromMainFrameCallback callback) throws Exception{

                /* try { */
                callback.onMessageFromMainFrameReceived(frameOrigin, scriptOrigin, data, isProxyInvolved);
                /* } catch (Exception e) {
                 *         e.printStackTrace(); */
                /* } */
        }
    ...
    private native void nativePostMessageToFrame(long nativeWebContentsAndroid, String frameName,
        ...
        /* BEGIN OSV_FREE */
        private native void nativeReceiveMessageFromMainFrame(long nativeWebContentsAndroid, ReceiveMessageFromMainFrameCallback callback);
        /* END OSV_FREE */
